              ...
              child: Container(
                child: Row(
                  ...
                  children: <Widget>[
                    Column(
                      children: <Widget>[
                        _buildFruitCard("Kiwi", "assets/1.jpg", "₹90",
                            0xff424242, 0XffFAF0DA),
                        SizedBox(
                        ...
                        GestureDetector(
                          ...
                          child: _buildFruitCard("Avocado", "assets/2.jpg",
                              "₹120", 0xff000000, 0XffE0E8CF),
                        ),
                        SizedBox(
                          height: 2 * SizeConfig.heightMultiplier,
                        ),
                        _buildFruitCard("Mango", "assets/3.jpg", "₹150",
                            0xff424242, 0XffF9EFB0),
                      ],
                    ),
                    Spacer(),
                    Column(
                      children: <Widget>[
                        ...
                        _buildFruitCard("Papaya", "assets/4.jpg", "₹45",
                            0xff424242, 0XffFDDCC1),
                        SizedBox(
                          height: 2 * SizeConfig.heightMultiplier,
                        ),
                        _buildFruitCard("Strawberry", "assets/5.jpg", "₹200",
                            0xff000000, 0XffF8C6CA),
                        SizedBox(
                          height: 2 * SizeConfig.heightMultiplier,
                        ),
                      ],
